...
def get_time_for_team_and_month(team, month):
    entries = Entry.objects.filter(team=team, created_at__year=month.year, created_at__month=month.month,
                                   is_tracked=True)
...
def get_time_for_user_and_project_and_month(team, project, user, month):
    entries = Entry.objects.filter(team=team, project=project, created_by=user, created_at__year=month.year,
                                   created_at__month=month.month, is_tracked=True)
