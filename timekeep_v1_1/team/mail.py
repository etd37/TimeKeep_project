...
def send_invitation(to_email, code, team):
    ...
    subject = 'TimeKeep'
    text_content = 'Invitation to TimeKeep. Your code is: %s' % code
    html_content = render_to_string('team/email_invitation.html', {'code': code, 'team': team, 'acceptation_url': acceptation_url})

    message = send_mail(subject, text_content, from_email, [to_email])
...
def send_invitation_accepted(team, invitation):
    ...
    message = send_mail(subject, text_content, from_email, [team.created_by.email])